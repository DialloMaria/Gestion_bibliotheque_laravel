   ...
   <div class="top-bar">
    ...
    <div class="container">
        <div class="header">
            ...
            <a href="ajouterRayon" class="add-category-btn">
                <i class="fas fa-plus"></i> Ajouter un Rayon
            </a>
        </div>
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="icon-buttons">
                            ...
                            <a href="modifierRayon/{{$rayons->id}}" title="Modifier"><i class="fas fa-pencil-alt"></i></a>
                            <a href="supprimerRayon/{{$rayons->id}}" title="Supprimer"><i class="fas fa-trash-alt"></i></a>
                        </div>
                    </div>
                </div>
            </div>
