...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2>AJOUTER UN RAYONS</h2>
            <form action="ajouterRayon/traitement" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="partie" rows="3" placeholder="partie" name="partie"></textarea>
                </div>
